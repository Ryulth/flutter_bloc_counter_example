...
class CounterBloc extends Bloc<CounterEvent, CounterState> {
  ...
  Stream<CounterState> _mapCounterIncrementToState(CounterIncrement event) async* {
  ...
  Stream<CounterState> _mapCounterDecrementToState(CounterDecrement event) async*{
    if (state is CounterLoaded) {
      final count = (state as CounterLoaded).count;
      final sum = count - event.num;
      yield CounterLoaded(sum);
